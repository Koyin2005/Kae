use crate::backend::{disassembly::disassemble, instructions::{Chunk, Constant, Program, ProgramMetadata}};
...
impl<'a> Compiler{
    pub fn new() -> Self{
        Self { current_chunk: Chunk::default(), constants: Vec::new(), metadata: Vec::new(), names: Vec::new() }
    }
